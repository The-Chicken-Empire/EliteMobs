...
execute if score @s DR_rod_condition matches 2 run function dressup_rod:rod/right_click/itemid
execute if score @s DR_rod_condition matches 3 run function dressup_rod:rod/right_click/color
execute if score @s DR_rod_condition matches 4 run function dressup_rod:rod/right_click/enchant
execute if score @s DR_rod_condition matches 5..6 run function dressup_rod:rod/right_click/saves
