...
execute at @s positioned ~-0.9 ~-0.9 ~-0.9 as @e[dx=0,type=#dressup_rod:check_target] run tag @s add DR_target1
execute at @s positioned ~-0.1 ~-0.1 ~-0.1 run tag @e[tag=DR_target1,dx=0,limit=1,sort=nearest] add DR_dc_target
