...
data modify entity @e[tag=DR_direction_checker,sort=nearest,limit=1] Rotation set from entity @s Rotation
...
#	ループ関数を実行
execute as @e[tag=DR_direction_checker,sort=nearest,limit=1] run function dressup_rod:rod/check/check_direction_loop
