...
#対象のデータを変更
item replace entity @e[tag=DR_dc_target,limit=1,sort=nearest] armor.head from entity @s armor.head
item replace entity @e[tag=DR_dc_target,limit=1,sort=nearest] armor.chest from entity @s armor.chest
item replace entity @e[tag=DR_dc_target,limit=1,sort=nearest] armor.legs from entity @s armor.legs
