#>elite_mobs:mobs/elites/zombies/monk/buff/skeletons/throw

execute positioned as @e[tag=nkkn.this,limit=1] run summon potion ~ ~1.5 ~ {Fire:2s,Tags:["init"],Item:{Count:1b,id:"minecraft:lingering_potion",tag:{CustomPotionColor:11645361,CustomPotionEffects:[{Id:33,Duration:1422,Amplifier:76b,ShowParticles:0b}]}}}
