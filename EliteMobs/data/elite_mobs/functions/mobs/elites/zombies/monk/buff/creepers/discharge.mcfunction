...
tag @e[type=creeper,tag=!EM_elite,tag=!EM_monk_buffed,distance=..3] add EM_monk_buffed
tag @e[type=creeper,tag=!EM_elite,tag=!EM_monk_buffed,distance=..3] add EM_elite
