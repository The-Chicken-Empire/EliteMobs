...
summon zombie ~ ~ ~ {Tags:["EM_nofalldamage","EM_elite","EM_drawn","EM_monk","init","EM_monk_buffer"],Glowing:1b,ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f],CustomName:'{"text":"アンデッドモンク","color":"light_purple"}',Attributes:[{Name:"minecraft:generic.max_health",Base:50}],Health:50f} 
