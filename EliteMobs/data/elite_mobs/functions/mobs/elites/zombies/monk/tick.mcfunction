...
execute if entity @e[tag=EM_monk_buffed,limit=1,type=skeleton] as @e[tag=EM_monk_buffed,type=skeleton] at @s run function elite_mobs:mobs/elites/zombies/monk/buff/skeletons/tick
