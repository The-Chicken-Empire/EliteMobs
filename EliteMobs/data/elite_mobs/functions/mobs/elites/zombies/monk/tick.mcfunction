...
execute if entity @e[tag=EM_monk,limit=1,predicate=elite_mobs:targeting] as @e[tag=EM_monk,predicate=elite_mobs:targeting] at @s run function elite_mobs:mobs/elites/zombies/monk/tick2
...
execute if entity @e[tag=EM_monk_buffed,limit=1,type=skeleton,predicate=elite_mobs:targeting] as @e[tag=EM_monk_buffed,type=skeleton,predicate=elite_mobs:targeting] at @s run function elite_mobs:mobs/elites/zombies/monk/buff/skeletons/tick
