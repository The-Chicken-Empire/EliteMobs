...
summon skeleton ~ ~ ~ {CustomName:'{"text":"ゼネラリストスケルトン","color":"dark_red"}',HandDropChances:[0.0f,0.0f],ArmorDropChances:[0.0f,0.0f,0.02f,0.02f],Glowing:1b,Health:50f,Tags:["EM_allrounder_bow","init","EM_shield","EM_upwithblock","EM_drawn","EM_elite","EM_allrounder"],Attributes:[{Name:"generic.max_health",Base:50.0d},{Name:"generic.movement_speed",Base:0.4},{Name:"generic.knockback_resistance",Base:0.5}]}
