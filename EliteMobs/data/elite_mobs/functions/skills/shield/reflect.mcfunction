...
execute positioned ^ ^ ^0.8 positioned ~-1 ~-0.5 ~-1 store result score #nkkn.counter2 EM_counter2 run data get entity @e[type=arrow,nbt={PierceLevel:0b,inGround:0b},dx=1,dy=1.5,dz=1,limit=1] Owner[0] 1
