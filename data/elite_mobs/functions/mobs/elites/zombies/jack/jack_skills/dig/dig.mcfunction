...
execute as @e[type=zombie,tag=EM_jack] at @s facing entity @p[distance=..10,limit=1] eyes run tp ^ ^ ^0.8
execute as @e[type=zombie,tag=EM_jack] at @s run damage @p[distance=..3] 30 player_attack by @e[tag=EM_jack,limit=1] from @e[tag=EM_jack,limit=1]
