...
item modify entity @s armor.head test_pack:enchantments/binding_curse
item modify entity @s armor.chest test_pack:enchantments/binding_curse
item modify entity @s armor.legs test_pack:enchantments/binding_curse
item modify entity @s armor.feet test_pack:enchantments/binding_curse
item modify entity @s weapon.mainhand test_pack:enchantments/binding_curse
item modify entity @s weapon.offhand test_pack:enchantments/binding_curse
