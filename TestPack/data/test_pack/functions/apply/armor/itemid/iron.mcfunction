...
data modify entity @e[tag=TP_container,type=armor_stand,limit=1,sort=nearest] ArmorItems[3].id set value "minecraft:iron_helmet"
data modify entity @e[tag=TP_container,type=armor_stand,limit=1,sort=nearest] ArmorItems[2].id set value "minecraft:iron_chestplate"
...
execute as @e[tag=TP_container,type=armor_stand,limit=1,sort=nearest] unless data entity @s ArmorItems[3].id run item replace entity @s armor.head with minecraft:iron_helmet
execute as @e[tag=TP_container,type=armor_stand,limit=1,sort=nearest] unless data entity @s ArmorItems[2].id run item replace entity @s armor.chest with minecraft:iron_chestplate
